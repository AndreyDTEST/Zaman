...
@allure.story("KBK")
def test_get_kbk_list(base_url, api_session, capture_responses):

    # Тест получения списка KBK
    endpoint = f"{base_url}/api/v1/smepayments/dictionaries/kbk"

    with allure.step("Отправляем запрос на получение KBK"):
